...
IMPORTANT: we will use the route HOST/PORT (URL) in the RestTemplate Object below
...
public class MessageService {
    ...
    public String getMessage() {
        ...
        return messageServiceGateway.getForEntity("http://externalroute-demo.apps.cluster-nbdqm.dynamic.redhatworkshops.io", String.class).getBody();
    }
...
public class HellokubernetesApplication {
    ...
    return factory -> factory.configureDefault(id -> new Resilience4JConfigBuilder(id)
            .circuitBreakerConfig(CircuitBreakerConfig.custom() // <1>
                                    ...
                                    .slidingWindow(5, 5, CircuitBreakerConfig.SlidingWindowType.COUNT_BASED) // <3>
                                    .build()
                                )
            .build());
	}
